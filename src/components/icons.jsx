// Small custom GitHub and LinkedIn icons — the icon package removed
// brand logos, so we draw these two ourselves instead.
export function GithubIcon({ size = 22, color = "currentColor" }) {
  return (
...
export function LinkedinIcon({ size = 22, color = "currentColor" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
